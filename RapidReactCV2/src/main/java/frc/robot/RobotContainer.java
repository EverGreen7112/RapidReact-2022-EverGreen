...
public class RobotContainer {
  ...
  public Command getAutonomousComand(){
    ...
    // reset robot's position in odometry in order to make sure movement is done correctly
    ...
    // then stop the robot's movements after finished (without it, it keeps going until it stops alone)
    return ramseteCommand.andThen(() -> DriveTrain.getInstance().tankDriveVolts(0, 0));
  }
